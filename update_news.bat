...
echo [1/5] Scraping noticias nuevas...
python scraper/multi_scraper.py
if %ERRORLEVEL% NEQ 0 goto error

echo [2/5] Reescritura paralela con IA...
python scraper/parallel_rewrite.py
if %ERRORLEVEL% NEQ 0 goto error

echo [3/5] Actualizando Mood de la ciudad...
python scraper/update_mood.py
if %ERRORLEVEL% NEQ 0 goto error

echo [4/5] Actualizando Pipeline de Podcast...
python scraper/update_podcast.py
if %ERRORLEVEL% NEQ 0 goto error

echo [5/5] Enviando noticias a Telegram...
